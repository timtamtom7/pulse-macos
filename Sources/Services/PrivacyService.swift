...
/// R19: Privacy service for Pulse
public final class PulsePrivacyService {
    public static let shared = PulsePrivacyService()
    private let keychainService = "com.pulse.macos.privacy"
    private init() {}
    
    public func getOrCreateKey() throws -> SymmetricKey {
        let query: [String: Any] = [kSecClass as String: kSecClassGenericPassword, kSecAttrService as String: keychainService, kSecAttrAccount as String: "pulse-key", kSecReturnData as String: true]
        ...
        let storeQuery: [String: Any] = [kSecClass as String: kSecClassGenericPassword, kSecAttrService as String: keychainService, kSecAttrAccount as String: "pulse-key", kSecValueData as String: keyData, kSecAttrAccessible as String: kSecAttrAccessibleWhenUnlockedThisDeviceOnly]
